...
public class Info {
	...
	System.out.print(Info.getBetweenDayNumber("2012-11-11 11:19", "2012-11-11 11:11"));
	 ...
	 public static void writeExcel(String fileName,String prosstr,java.util.List<List> plist,HttpServletRequest request, HttpServletResponse response){    
	        ...
	        try {
				response.sendRedirect("/petsns/upload?filename="+fileName.substring(fileName.lastIndexOf("/")+1));
			} catch (IOException e) {
				e.printStackTrace();
			}
	 ...
	 public static String getFileUpInfo()
		{
			String jscode = "";
			jscode+="<script src=/petsns/js/popup.js></script>";
	  ...
	  public static String tform(HashMap map)
		{
	    	...
	    	Set set = map.entrySet();
	    	 ...
	    	 jscode+=" if(f1."+str1+")\n";
	    	  ...
	    	  jscode+="{\n";
	    	  jscode+="document.getElementById(\"txt\").src=\"/petsns/upfile/"+map.get("filename")+"\";\n";
	    	  jscode+="}\n";
	    	  
	    	  jscode+="if(document.getElementById(\"txt2\"))\n";
	    	  jscode+="{\n";
	    	  jscode+="document.getElementById(\"txt2\").src=\"/petsns/upfile/"+map.get("filename2")+"\";\n";
	    	  jscode+="}\n";
	    	  
	    	  jscode+="if(document.getElementById(\"txt3\"))\n";
	    	  jscode+="{\n";
	    	  jscode+="document.getElementById(\"txt3\").src=\"/petsns/upfile/"+map.get("filename3")+"\";\n";
	    	  jscode+="}\n";
	    	  
	    	  jscode+="if(document.getElementById(\"txt4\"))\n";
	    	  jscode+="{\n";
	    	  jscode+="document.getElementById(\"txt4\").src=\"/petsns/upfile/"+map.get("filename4")+"\";\n";
	    	  jscode+="}\n";
	    	  
	    	  jscode+="if(document.getElementById(\"txt5\"))\n";
	    	  jscode+="{\n";
	    	  jscode+="document.getElementById(\"txt5\").src=\"/petsns/upfile/"+map.get("filename5")+"\";\n";
	    	  jscode+="}\n";
	...
	{
		String jscode = "";
		jscode+="<img style=\"cursor: hand;margin:3px\" onclick=\"uploadimg()\" src=\"/petsns/js/nopic.jpg\" id=txt height=\""+height+"\"/>";
		jscode+="<input type=hidden name=\"filename\" id=\"filename\" value=\"\" />";
		jscode+="<script type=\"text/javascript\"  src=\"/petsns/js/popups.js\"></script>";
		return jscode;
	}
	...
	{
		String jscode = "";
		jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg2()\" src=\"/petsns/js/nopic.jpg\" id=txt2 height=\""+height+"\"/>";
		jscode+="<input type=hidden name=\"filename2\" id=\"filename2\" value=\"\" />";
		jscode+="<script type=\"text/javascript\"  src=\"/petsns/js/popup.js\"></script>";
		return jscode;
	}
	...
	{
		String jscode = "";
		jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg3()\" src=\"/petsns/js/nopic.jpg\" id=txt3 height=\""+height+"\"/>";
	...
	{
		String jscode = "";
		jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg4()\" src=\"/petsns/js/nopic.jpg\" id=txt4 height=\""+height+"\"/>";
	...
	{
		String jscode = "";
		jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg5()\" src=\"/petsns/js/nopic.jpg\" id=txt5 height=\""+height+"\"/>";
	...
	public static String fck(int height,String content)
	{
		...
		jscode+="<script type=\"text/javascript\"  src=\"/petsns/fckeditor/fckeditor.js\"></script>";
		jscode+="<script language=\"javascript\">";
		jscode+="function fckinit()";
		jscode+="{";
		jscode+=" var of = new FCKeditor(\"content\");";
		jscode+="of.BasePath=\"/petsns/fckeditor/\";";
	    ...
	    public static void delPic(String path,String img)
		{
	     ...
	     public static String getCol(String type,String trid,String name,String url,String display)
	     {
   		 ...
   		 html=  "<table width=\"151\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\"> \n" +
					...
					"<tr>\n"+
					"<td height=\"23\" background=\"images/main_47.gif\" id=\"imgmenu"+trid+"\" class=\"menu_title\" onmouseover=\"this.className='menu_title2';\" onclick=\"showsubmenu("+trid+")\" onmouseout=\"this.className='menu_title';\" style=\"cursor:hand\"><table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\n"+
					"<tr>\n"+
					"<td width=\"18%\">&nbsp;</td>\n"+
					"<td width=\"82%\" class=\"STYLE1\">"+name+"</td>\n"+
					"</tr>\n"+
					"</table></td>\n"+
					"</tr>";
	    	 }
   		 ...
   		 html=  "<tr> \n"+
                   ...
                   "<tr> \n"+
                   "<td height=\"20\" style=\"cursor:hand\" onmouseover=\"this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#7bc4d3'; \"onmouseout=\"this.style.borderStyle='none'\"   onClick=\"go('"+url+"')\" ><span class=\"STYLE3\">"+name+"</span></td> \n"+
                   "</tr> \n"+
                   "</table></td> \n"+
                   "</tr>";
	    	 }
	    	 ...
	    	 {
   		 html=  "<tr> \n"+
                   "<td background=\"images/main_51.gif\" id=\"submenu"+trid+"\" style=\"display:"+display+"\" ><div class=\"sec_menu\" > \n"+
