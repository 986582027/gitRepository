...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="10" bgcolor="#A19887" class="margin_b_10">
  <tr>
    <td height="197" valign="top"><table width="100%" border="0" cellpadding="5" cellspacing="0">
      <tr>
        <td valign="top" class="TD01"><table width="100%" border="0" cellpadding="0" cellspacing="0" background="frontfiles/images/in_23.jpg" class="margin_b_8">
          <tr>
            <td width="92%" height="25" valign="top" background="frontfiles/images/in_26.jpg" class="padding_L_10 padding_T_5"><strong class="font_14 font_ffF">打折专区 </strong></td>
       ...
       <table width="99%" border="0" cellpadding="0" cellspacing="0" align="center" >
                    ...
                    sql+=" and discount!='' order by id desc";
                    
                     PageManager pageManager = PageManager.getPage("dzzq.jsp?1=1&key="+key, 5, request);
