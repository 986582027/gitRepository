 ...
 <table width="100%" border="0" cellpadding="5" cellspacing="0">
      <tr>
        <td valign="top" class="TD01"><table width="100%" border="0" cellpadding="0" cellspacing="0" background="frontfiles/images/in_23.jpg" class="margin_b_8">
          <tr>
            <td width="92%" height="25" valign="top" background="frontfiles/images/in_26.jpg" class="padding_L_10 padding_T_5"><strong class="font_14 font_ffF">宠物知识</strong></td>
...
<tr>
                      ...
                      <TABLE id=standard border=0 cellSpacing=1 
                                cellPadding=0 width="115%" bgColor=#BFB7A4>
<TBODY>
  ...
  <tr align="center" valign="top">
	...
	for(HashMap map:list){ 
     %>
        ...
        <tr>
          <td width="459" height="32" align="left" valign="middle" class="dd">
          ...
          <%=map.get("title") %>
           ...
           <td width="211" height="32" align="left" valign="middle" class="dd">
           <%=map.get("savetime") %>
