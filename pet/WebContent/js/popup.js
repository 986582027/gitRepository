...
function uploadimg()
{
pop("/petsns/js/uploadimg.jsp","上传图片",300,77)
}

function uploadimg2()
{
pop("/petsns/js/uploadimg2.jsp","上传图片",300,77)
}

function uploadimg3()
{
pop("/petsns/js/uploadimg3.jsp","上传图片",300,77)
}

function uploadimg4()
{
pop("/petsns/js/uploadimg4.jsp","上传图片",300,77)
}


function uploadimg5()
{
pop("/petsns/js/uploadimg5.jsp","上传图片",300,77)
}


function uploaddoc()
{
pop("/petsns/js/uploaddoc.jsp","docupload",300,77)
}

function uploaddoc2()
{
pop("/petsns/js/uploaddoc2.jsp","docupload",300,77)
}

function uploaddoc3()
{
pop("/petsns/js/uploaddoc3.jsp","docupload",300,77)
}
...
build:function(){
   ...
   var close='<img id="dialogBoxClose" title="关闭" src=/petsns/js/dialogclose.gif  />';
